...
SECRET_KEY = 'django-insecure-77&t6d*y-ccn5&2qrab6iwhb&ki^s)u#)ec!4bti(+x=$iy-vc'
...
# dango-allauthを利用するdjango-contrib.sitesを使うためにサイト識別用IDを設定
SITE_ID = 1
...
ACCOUNT_LOGOUT_REFIRECT_URL = 'account_login'

# ログアウトリンクのクリック一発でログアウトする設定
ACCOUNT_LOGOUT_ON_GET = True

# django-allauthが送信する眼０流の賢明に自動付与される接頭辞をブランクにする設定
